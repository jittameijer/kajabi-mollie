...
import { alert } from "../lib/alert.js"; // ✅ nieuw voor Slack alerts
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 2️⃣ Activeer juiste offer-URL (optioneel)
    const offerEnvKey =
    ...
    // 3️⃣ Eerste betaling (mandaat) aanmaken
    ...
    // 4️⃣ Alles goed → success-melding (optioneel)
